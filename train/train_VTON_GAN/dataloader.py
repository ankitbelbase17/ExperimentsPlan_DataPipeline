...
class VTONGANDataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            pose = self.load_image_from_s3(f"{self.root_dir}/pose/{person_id}.jpg")
...
def get_dataloader(batch_size=None, split='train', difficulty='medium', s3_prefixes=None):
    ...
    try:
        ...
        # Define transforms for VTON-GAN (256x256 typically)
