#!/bin/bash
# Evaluate all models on VITON-HD benchmark dataset
# Dataset location: baselines/viton-hd/test

set -e

DATASET_DIR="baselines/viton-hd/test"
OUTPUT_DIR="evaluation_results/viton-hd"
DEVICE="cuda"

echo "=========================================="
echo "VITON-HD Benchmark Evaluation"
echo "=========================================="
...
if [ ! -d "$DATASET_DIR" ]; then
    ...
    echo "Please ensure VITON-HD test set is downloaded to baselines/viton-hd/test/"
    exit 1
fi
...
echo "=========================================="
echo "VITON-HD Evaluation Complete!"
echo "=========================================="
...
print('\n' + '='*60)
print('VITON-HD BENCHMARK RESULTS SUMMARY')
print('='*60)
