#!/bin/bash
# Evaluate all models on DeepFashion benchmark dataset
# Dataset location: baselines/deepfashion/test

set -e

DATASET_DIR="baselines/deepfashion/test"
OUTPUT_DIR="evaluation_results/deepfashion"
DEVICE="cuda"

echo "=========================================="
echo "DeepFashion Benchmark Evaluation"
echo "=========================================="
...
if [ ! -d "$DATASET_DIR" ]; then
    ...
    echo "Please ensure DeepFashion test set is downloaded to baselines/deepfashion/test/"
    exit 1
fi
...
echo "=========================================="
echo "DeepFashion Evaluation Complete!"
echo "=========================================="
...
print('\n' + '='*60)
print('DEEPFASHION BENCHMARK RESULTS SUMMARY')
print('='*60)
