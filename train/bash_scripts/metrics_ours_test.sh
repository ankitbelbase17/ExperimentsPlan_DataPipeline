#!/bin/bash
# Evaluate all models on our custom test dataset
# Dataset location: dataset_ultimate/test (our curated test set)

set -e

DATASET_DIR="dataset_ultimate/test"
OUTPUT_DIR="evaluation_results/ours_test"
DEVICE="cuda"

echo "=========================================="
echo "Our Custom Test Set Evaluation"
echo "=========================================="
...
if [ ! -d "$DATASET_DIR" ]; then
    ...
    echo "Please ensure custom test set exists at dataset_ultimate/test/"
    exit 1
fi
...
echo "=========================================="
echo "Custom Test Set Evaluation Complete!"
echo "=========================================="
...
print('\n' + '='*60)
print('OUR CUSTOM TEST SET RESULTS SUMMARY')
print('='*60)
